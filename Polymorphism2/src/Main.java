...
public class Main {
    ...
    // Javadaki bütün classlar "Object" classından türemiştir.!!!!!
    ...
    public static void main(String[] args) {
       ...
       if (kopek instanceof Kopek) {
           System.out.println("Bu nesne Kopek sınıfından...");     (kopek instanceof Hayvan yazsaydımda doğru olurdu çünkü kopek sınıfı hayvan sınıfından türemiştir.)
       }*/
